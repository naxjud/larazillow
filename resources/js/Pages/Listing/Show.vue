    ...
    <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
        ...
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <div>
                    <label class="input_label">Interest rate ({{interestRate}}%)</label>
                    <input v-model.number="interestRate" type="range" min="0.1" max="30" step="0.1"
                    class="w-full h-4 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">


                    <label class="input_label">Duration ({{duration}} years)</label>
                    ...
                    <div class="mt-2 text-gray-500">
                        ...
                        <div class="flex justify-between broder border-t-2 border-gray-400 dark:border-gray-700">
